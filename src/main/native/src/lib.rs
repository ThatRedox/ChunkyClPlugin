...
use crate::panic_catch::panic_catch;
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_NativeLoader_init(_env: JNIEnv, _class: JClass) {
    panic_catch::init();
}

#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_SynchronizedRustResourcePalette_create(env: JNIEnv, _class: JClass) -> jlong {
    panic_catch(&env, || {
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_SynchronizedRustResourcePalette_drop(env: JNIEnv, _class: JClass, address: jlong) {
    panic_catch(&env, || {
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_SynchronizedRustBvh_drop(env: JNIEnv, _class: JClass, address: jlong) {
    panic_catch(&env, || {
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_SynchronizedRustOctree_drop(env: JNIEnv, _class: JClass, address: jlong) {
    panic_catch(&env, || {
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_RustPathTracer_create(env: JNIEnv, _class: JClass, octree: jlong) -> jlong {
    panic_catch(&env, || {
...
#[no_mangle]
pub extern "system" fn Java_dev_thatredox_chunkynative_rust_ffi_RustPathTracer_drop(env: JNIEnv, _class: JClass, address: jlong) {
    panic_catch(&env, || {
